...
<div class="container">
    ...
    <div class="row" style="padding: 20px 0 10px 0;">
        <div class="col s12">
            ...
            <p class="center-align">Testimonials from SBS Consulting's industry contacts.</p>
        </div>
    </div>
            ...
            <div class="carousel testimonial about carousel-slider center" data-indicators="true">
                ...
                <div class="carousel-item" href="#">
                    <div class="row">
                        ...
                        <div class="col s12 m8 left-align">
                            <div class="testimonial-content">
                                <p>We couldn’t be more thrilled with the sales training we received from SBS Consulting. It became immediately clear the first day our trainer spent speaking with our sales team that the time management and outbound marketing skills and strategies he was sharing are just as applicable to the performing arts business as they are to the sports industry. In-person, on-site training of this high caliber is typically beyond our financial means, but SBS worked with us in creating a sales training partnership that allows us to benefit from their immense expertise while staying within our limited budget. </p>
                                <p class="heavy">
                                    Scott Sanger<br/>
