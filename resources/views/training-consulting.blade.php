...
@section('hero')
    <div class="row hero sbs-hero bg-image transparent-box training-consulting">
        <div class="col s12 m6 offset-m2">
            <h2 class="header" style="max-width:550px;min-width:300px;">Our priority is you! We work together to identify your challenges and then provide solutions that deliver results.</h2>
            <br>
            <div style="display: grid;grid-template-columns: 185px auto;">
                <h5><a class="no-underline sbs-arrow-link" href="/contact">Let's get started</a></h5>
                <h5><a class="no-underline sbs-arrow-link" href="/contact"><img src="/images/sbs-red-arrow-right.png" style="width:50px;"></a></h5>
                <h5><a class="no-underline sbs-arrow-link" href="/clients">See our clients</a></h5>
                <h5><a class="no-underline sbs-arrow-link" href="/clients"><img src="/images/sbs-red-arrow-right.png" style="width:50px;"></a></h5>
            </div>
        </div>
    </div>
@endsection
@section('content')
<div class="container">
    <div class="row white-text" id="areas-of-expertise" style="margin-top:30px;">
