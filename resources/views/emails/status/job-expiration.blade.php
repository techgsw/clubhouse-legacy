@component('emails.layout')
    @slot('body')
        ...
        <p>Thank you for posting your job on <span style="color: #EB2935;">the</span>Clubhouse job board!  We hope the process has been smooth and you've been able to connect with some quality candidates. If for some reason you haven't been able to identify the right fit for the job, you are welcome to extend your listing for another 30 days on the job board for just $250.</p>
