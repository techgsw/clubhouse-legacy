@component('emails.layout')
    ...
    @slot('body')
        ...
        <p><i>Our advice?</i> Make it a goal to schedule at least one call per week. Start with people you’re most interested in talking with and expand from there. There is absolutely no downside here and if you aren’t actively networking in sports, you’re missing out!</p>
