@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>Through <span style="color: #EB2935;">the</span>Clubhouse you can schedule 30-minute calls with any mentor. Use these calls to network, learn, build relationships, and gain insights from people who’ve done it at the highest levels in sports.</p>
