@component('emails.layout')
    ...
    @slot('body')
        ...
        <p><strong>As a Clubhouse PRO member, you now get access to 1:1 <a href="{{ env('CLUBHOUSE_URL') }}/career-services">career services</a>.</strong> These sessions are facilitated by Bob Hamer, President and Founder of SBS and <span style="color: #EB2935;">the</span>Clubhouse.</p>
