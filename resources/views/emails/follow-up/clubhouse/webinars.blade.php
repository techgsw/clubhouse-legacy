@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>In <span style="color: #EB2935;">the</span>Clubhouse we host 1-2 educational webinars per month, sometimes more. These sessions are moderated by our team, but often include industry guest speakers who share advice and sports industry best practices.</p>
