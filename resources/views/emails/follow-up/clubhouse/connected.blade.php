@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>Please be sure to update your <a href="{{ env('CLUBHOUSE_URL') }}/user/{{ $user->id }}/profile">career profile</a> so we can tailor the content in <span style="color: #EB2935;">the</span>Clubhouse to your preferences.</p>
