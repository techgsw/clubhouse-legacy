@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>Have some feedback for us? Has something changed on your end? Let us know by emailing us here: <a href="mailto:{{ __('email.info_address') }}">{{ __('email.info_address') }}</a></p>
