@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>There are always new things happening in <span style="color: #EB2935;">the</span>Clubhouse<sup>&#174;</sup>. Login and check them out <a href="{{ env('CLUBHOUSE_URL') }}/login">here</a>.</p>
        ...
        <p>Have some feedback for us? Has something changed on your end? Let us know by emailing us here: <a href="mailto:theclubhouse@generalsports.com">theclubhouse@generalsports.com</a></p>
