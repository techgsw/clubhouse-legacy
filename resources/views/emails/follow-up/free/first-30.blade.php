@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>We get that you’re busy, so if you haven’t had time to check out our content in <span style="color: #EB2935;">the</span>Clubhouse<sup>&#174;</sup>, that’s ok!</p>
        <p>Here’s a friendly reminder of what you get access to as a FREE member of <span style="color: #EB2935;">the</span>Clubhouse<sup>&#174;</sup>:</p>
        <ul>
