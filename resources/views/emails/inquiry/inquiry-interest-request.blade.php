@component('emails.layout')
    @slot('body')
        ...
        <p>
            <a href="{{ env('CLUBHOUSE_URL') }}/inquiry/feedback/{{ $inquiry->id }}?interest=interested&token={{ $inquiry->job_interest_token }}">Yes, I am interested.</a>
            <br />
            <a href="{{ env('CLUBHOUSE_URL') }}/inquiry/feedback/{{ $inquiry->id }}?interest=not_interested&token={{ $inquiry->job_interest_token }}">No, I am not interested.</a>
        </p>
