@component('emails.layout')
    ...
    @slot('body')
        ...
        <p>At any time you can choose to become a <a href="{{ env('CLUBHOUSE_URL') }}/pro-membership">Clubhouse Pro</a>, and your <span style="text-decoration:underline;">free {{CLUBHOUSE_FREE_TRIAL_DAYS}}-day trial</span> will unlock a number of more personalized opportunities! Included will be:</p>
        <p>
            <ul>
