@component('emails.layout')
    @slot('body')
        ...
        <p>As a member of <span style="color: #EB2935;">the</span>Clubhouse<sup>&#174;</sup> you have been identified as a potential match for an opportunity with the <strong>{{ $contact_job->job->organization_name }}</strong>.  They are currently seeking a new <strong>{{ $contact_job->job->title }}</strong> and the hiring manager would like to arrange a conversation to discuss the opportunity further.</p>
