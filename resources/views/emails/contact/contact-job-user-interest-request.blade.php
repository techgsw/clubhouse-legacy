@component('emails.layout')
    @slot('body')
        ...
        <br />
        <p style="font-size: 10px; color: grey;">Don't want to hear from us again? Let us know by <a href="{{ env('CLUBHOUSE_URL') }}/user-assigned/feedback/{{ $contact_job->id }}?interest=dnc&token={{ $contact_job->job_interest_token }}">clicking here</a></p>
    @endslot
@endcomponent
