@component('emails.layout')
    @slot('body')
        ...
        <p>Based on your work experience and qualifications, <strong>{{ $contact_job->job->organization_name }}</strong> want to consider you for an open job on their team.</p>
                    ...
                    <table border="0" cellspacing="20" cellpadding="0" align="center">
                        <tr>
                            <td bgcolor="#EB2935" style="padding: 12px 18px 12px 18px; border-radius: 2px;" align="center">
                                <a href="{{ env('CLUBHOUSE_URL') }}/user-assigned/feedback/{{ $contact_job->id }}?interest=interested&token={{ $contact_job->job_interest_token }}" style="text-decoration:none;display:inline-block;color:#FFF;">
                                    <strong>Yes</strong>
                                </a>
                            </td>
                            <td bgcolor="#EB2935" style="padding: 12px 18px 12px 18px; border-radius: 2px;" align="center">
                                <a href="{{ env('CLUBHOUSE_URL') }}/user-assigned/feedback/{{ $contact_job->id }}?interest=not-interested&token={{ $contact_job->job_interest_token }}" style="text-decoration:none;display:inline-block;color:#FFF;">
                                    <strong>No</strong>
                                </a>
                            </td>
                        </tr>
