@component('emails.layout')
    @slot('body')
        ...
        <p>Hope all is well!  Your information came across my desk earlier and I wanted to reach out as I thought you may be a good fit for one of the new job opportunities we are currently supporting with the (team/business) as they are seeking a (job title) to join their team.</p>
