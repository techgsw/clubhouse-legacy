@component('emails.layout')
    @slot('body')
        ...
        <p>As a member of the SBS Consulting network, you have been identified as a potential match for one of our partners job openings.  The <strong>{{ $contact_job->job->organization_name }}</strong> are currently seeking a new <strong>{{ $contact_job->job->title }}</strong>, and the hiring manager would like to arrange a conversation to discuss the opportunity further.</p>
