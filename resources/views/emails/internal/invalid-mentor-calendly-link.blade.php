@component('emails.layout')
    @slot('body')
        ...
        <p><b>NOTE:</b> This script checks all active mentors' Calend.ly page for the text "is not valid" or "calendar is currently unavailable". If you notice any of these pages are in fact valid, please let the developers know along with the valid link.</p>
