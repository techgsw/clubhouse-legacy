...
@component('emails.layout')
    @slot('body')
        ...
        <ul>
            ...
            <li>Within three business days someone from theClubhouse team will be back in touch via email with either: a calendar invite to schedule the session, OR with a note to find a different date/time based on the mentors updated availability.</li>
        </ul>
