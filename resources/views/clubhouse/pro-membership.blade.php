                ...
                <div class="card large">
                    <div class="card-content" style="display: flex; flex-flow: column; justify-content: space-between;">
                        ...
                        <div class="col s12 center-align" style="padding-bottom: 10px;">
                            @if (Auth::guest())
                                <a href="#register-modal" class="buy-now btn sbs-red" style="margin-top: 18px;">Go Pro at {{ money_format('%.2n', $monthly_membership_option->price) }}/month</a>
                            @else
                                <a href="{{$monthly_membership_option->getURL(false, 'checkout')}}" class="buy-now btn sbs-red" style="margin-top: 18px;">Go Pro Monthly</a>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="card large">
                    <div class="card-content" style="display: flex; flex-flow: column; justify-content: space-between;">
                        ...
                        <div class="col s12 center-align" style="padding-bottom: 10px;">
                            ...
                            @else
                                <a href="{{ $annual_membership_option->getURL(false, 'checkout') }}" class="buy-now btn sbs-red" style="margin-top: 18px;">Go Pro Annually</a>
                            @endif
                        </div>
                    </div>
                </div>
