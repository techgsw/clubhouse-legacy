...
<div class="container">
    <div class="center-align row">
        ...
        @if ($job_type_id != JOB_TYPE_ID['sbs_default'])
            <p style="font-size: 16px; font-weight: 400;">If you haven't found the right fit for your open position, you can extend your job listing for an additional 30 days on our board.</p>
