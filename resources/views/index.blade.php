...
<div class="container">
    ...
    <div class="row">
        <div class="col s12 center-align">
            <img src="/images/home/clients.gif" alt="" style="margin-bottom: 60px;">
        </div>
    </div>
</div>
<div class="row" style="margin: 0;">
    <div class="col s12 m6 push-m6" style="
        ...
        padding: 0;
    "></div>
    <div class="col s12 m6 pull-m6" style="
...
<div class="row" style="margin: 0;">
    <div class="col s12 m6" style="
        background: url('images/home/recruiting.jpg');
        background-size: cover;
        background-position: center;
        min-height: 300px;
        padding: 0;
                    ...
                    <div class="row">
                        ...
                        <div class="col s8 left-align">
                            <div class="testimonial-content">
                                ...
                                <p class="heavy">Jason Rowley</p>
                                <p class="heavy">President</p>
                                <p class="heavy">Phoenix Suns &amp; Mercury</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s8 left-align">
                            <div class="testimonial-content">
                                ...
                                <p class="heavy">Amber Cox</p>
                                <p class="heavy">Vice President - Marketing</p>
                                <p class="heavy">Connecticut Sun &amp; NE Black Wolves</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s8 left-align">
                            <div class="testimonial-content">
                                ...
                                <p class="heavy">Colin Twomey</p>
                                <p class="heavy">Sr. Director – Business Strategy &amp; Analytics</p>
                                <p class="heavy">Sacramento Kings</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s8 left-align">
                            <div class="testimonial-content">
                                ...
                                <p class="heavy">Dave Baldwin</p>
                                <p class="heavy">Sr. Director – Business Development &amp; Premium Sales</p>
                                <p class="heavy">Miami Dolphins</p>
                            </div>
                        </div>
                    </div>
                </div>
