        ...
        <div class="col s12 m10 offset-m1">
            <div class="card ">
                <div class="card-content">
                    ...
                    <br />
                    <p>If you have any questions about <span style="color: #EB2935;">the</span>Clubhouse<sup>&#174;</sup> or the status of this job you can always email us at <a href="mailto:{{ __('email.info_address') }}">{{ __('email.info_address') }}</a></p>
                    <br />
