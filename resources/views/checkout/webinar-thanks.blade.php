        ...
        <div class="col s12 m10 offset-m1">
            <div class="card checkout-card">
                <div class="card-content">
                    ...
                    <p>Thanks for being a part of <span class="sbs-red-text">the</span>Clubhouse<sup>&#174;</sup> community. See you on the call!</p>
                    <p>-<span class="sbs-red-text">the</span>Clubhouse<sup>&#174;</sup> team</p>
                </div>
            </div>
        </div>
    </div>
