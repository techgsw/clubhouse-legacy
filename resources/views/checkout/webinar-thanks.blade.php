        ...
        <div class="col s12 m10 offset-m1">
            <div class="card checkout-card">
                <div class="card-content">
                    ...
                    <p>If you do miss the live call, all registered attendees will be emailed the recording of the session after the call takes place and <strong>Clubhoues Pro</strong> memebers can download it at any time on <span class="sbs-red-text">the</span>Clubhouse Webinar home page.</p>
                    <p>See you there!</p>
                </div>
            </div>
        </div>
