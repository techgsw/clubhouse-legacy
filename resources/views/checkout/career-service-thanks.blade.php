            ...
            <div class="card checkout-card">
                <div class="card-content">
                    ...
                    @else
                        ...
                        <p>If for some reason you don’t hear from us within the next two business days, please email us directly at <a href="mailto:theclubhouse@generalsports.com">theclubhouse@generalsports.com.</a></p>
                    @endif
                </div>
            </div>
        </div>
