    ...
    <div class="container" style="margin-bottom:75px;">
        ...
        <div class="row gray-bg" style="padding: 30px 30px;">
            ...
            <div class="row center-align">
                <div class="row s12 m12 l10 center-align">
                    <div class="col push-m1 m10 push-l2 l10 center-align">
                        <div class="col s12 m6 l2 center-align">
                            <a href="/blog/eric-kussin--my-samehere-story" class="no-underline">
                                <a class="no-underline" href="https://www.linkedin.com/in/eric-kussin-5010a37/" target="_blank"><img src="/images/same-here/eric-same-here-cropped.jpg" style="width: 120%; max-width: 180px; border-radius: 50%; padding-right: 20px;"></a>
                                <h5>
                                    Eric Kussin
                        ...
                        <div class="col s12 m6 l2 center-align">
                            <a href="https://www.linkedin.com/in/lou-depaoli-3a41595/" target="_blank" class="no-underline"><img src="/images/same-here/lou-de-paoli.png" style="width: 120%; max-width: 180px; border-radius: 50%; padding-right: 20px;"></a>
                            <h5>
                                Lou De Paoli
                        ...
                        <div class="col s12 m6 l2 center-align">
                            <a href="https://www.linkedin.com/in/travisapple/" target="_blank" class="no-underline"><img src="/images/same-here/travis-apple.png" style="width: 120%; max-width: 180px; border-radius: 50%; padding-right: 20px;"></a>
                            <h5>
                                Travis Apple
                        ...
                        <div class="col s12 m6 l2 center-align">
                            <a href="https://www.linkedin.com/in/jentrymullins/" target="_blank" class="no-underline"><img src="/images/same-here/jentry-mullins.png" style="width: 120%; max-width: 180px; border-radius: 50%; padding-right: 20px;"></a>
                            <h5>
                                Jentry Mullins
                        ...
                        <div class="col s12 m6 l2 center-align">
                            <a href="https://www.linkedin.com/in/kayla-lawson4/" target="_blank" class="no-underline"><img src="/images/same-here/kayla-lawson.png" style="width: 120%; max-width: 180px; border-radius: 50%; padding-right: 20px;"></a>
                            <h5>
                                Kayla Lawson
