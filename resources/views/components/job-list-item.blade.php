<a href="{{ $job->getURL() }}">
    <div class="col s12 l6 job-index {{ $job->featured ? 'featured-job' : '' }}" style="min-height: 200px;">
        ...
        <div class="col s12 m3 center-align hide-on-small-only">
            <div>
                @can ('create-inquiry')
                    <a style="margin-top: 12px;" href="{{ $job->getURL() }}" class="btn btn-small  white black-text">Apply</a>
                @else
                    <a style="margin-top: 12px;" href="/register" class="btn btn-small white black-text">Apply</a>
                @endcan
            </div>
            @can ('edit-job', $job)
                <div class="small left-align" style="margin-top: 16px;">
