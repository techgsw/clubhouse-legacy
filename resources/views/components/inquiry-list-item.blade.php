        ...
        <div class="col s12">
            @can ('edit-inquiry', $inquiry)
                ...
                <div style="margin: 4px 0;">
                    ...
                    <button type="button" id="pipeline-label-{{ $inquiry->id }}" style="display:{{!empty($inquiry->reason)  ? '' : 'none'}};" class="flat-button red small input-control reason-note-button" input-id="step">{{$inquiry->reason}}</button>                  
